...
class AnalyticsService {
    constructor() {
        // Legacy local cache replaced by centralized CacheService where appropriate
    }

    /**
     * Get predictive revenue and pipeline metrics (WITH CACHING via centralized CacheService)
     */
     ...
     * Optimized with centralized caching and thundering herd protection
     */
