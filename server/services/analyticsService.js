...
class AnalyticsService {
    ...
    async getBIDashboard() {
        ...
        if (this.biCache.pendingPromise) {
            return this.biCache.pendingPromise;
        }

        this.biCache.pendingPromise = (async () => {
            try {
                ...
                this.biCache.pendingPromise = null;
            }
        })();
    ...
    async getNeighborhoodStatsMap() {
        ...
        if (this.cache.pendingPromise) {
            return this.cache.pendingPromise;
        }

        this.cache.pendingPromise = (async () => {
            try {
                ...
                this.cache.pendingPromise = null;
            }
        })();
