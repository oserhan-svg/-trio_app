...
router.post('/extension-sync', extensionAuth, whatsappController.syncExtension); // Often used by extension with different auth or none? Keeping consistent with old file (no auth middleware visible in old snippet but controller checks are safe)
