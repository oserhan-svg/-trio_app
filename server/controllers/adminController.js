...
exports.getDashboardStats = async (req, res) => {
    try {
        // ⚡ Bolt: Batch independent counting queries concurrently to eliminate N+1 sequential bottlenecks
        const [
            totalProperties,
            sahibindenCount,
            hepsiemlakCount,
            ...
            // 2. By Source - Sahibinden
            prisma.property.count({
                where: { url: { contains: 'sahibinden.com' } }
            }),
            // 2. By Source - Hepsiemlak
            prisma.property.count({
                where: {
                    OR: [
