...
exports.getDashboardStats = async (req, res) => {
    try {
        // Optimization: Execute all independent count queries concurrently using Promise.all
        // This resolves an N+1-like sequence of blocking DB queries, significantly reducing total response time.
        const [
            totalProperties,
            sahibindenCount,
            hepsiemlakCount,
