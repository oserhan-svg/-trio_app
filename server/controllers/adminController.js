...
exports.getDashboardStats = async (req, res) => {
    try {
        // 1. Total Properties & Sources & Assignment Stats
        // ⚡ Bolt: Batched multiple sequential count queries into a single Promise.all to reduce database roundtrips and improve response time.
