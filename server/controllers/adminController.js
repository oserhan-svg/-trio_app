...
exports.getDashboardStats = async (req, res) => {
    try {
        // 1 & 2 & 3. Run all independent property count queries concurrently for performance
        // Optimizes by using Promise.all() to reduce latency from sequential DB calls
        const [
            totalProperties,
            sahibindenCount,
            hepsiemlakCount,
