...
exports.getDashboardStats = async (req, res) => {
    try {
        // ⚡ Bolt Optimization: Grouped independent Prisma queries with Promise.all to reduce latency by executing them concurrently. Expected impact: reduced DB wait time from sum of all query times to max of longest single query time.
        const [
            totalProperties,
            sahibindenCount,
            hepsiemlakCount,
