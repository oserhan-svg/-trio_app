...
const getStats = async (req, res) => {
    try {
        ...
        // ⚡ Bolt: Execute independent dashboard queries concurrently to reduce latency.
        // Previously these awaited sequentially, taking sum of individual latencies.
        const [
            statsMap,
            supplyDemand,
            totalProperties,
        ...
        console.log(`✅ Analytics concurrent queries calculated in ${Date.now() - start}ms`);
