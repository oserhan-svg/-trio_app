...
const getStats = async (req, res) => {
    try {
        ...
        // Optimization: Execute all independent admin stats count queries concurrently
        // This resolves sequential blocking DB queries, significantly reducing latency.
        const [
            totalProperties,
            sahibindenCount,
            hepsiemlakCount,
