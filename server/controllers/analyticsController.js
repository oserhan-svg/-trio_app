...
const getStats = async (req, res) => {
    try {
        ...
        // Parallelize all independent database and service calls
        // This significantly improves response time by overlapping I/O wait times
        const [
            statsMap,
            supplyDemand,
            totalProperties,
        ...
        console.log(`✅ Dashboard analytics calculated in ${Date.now() - start}ms`);
