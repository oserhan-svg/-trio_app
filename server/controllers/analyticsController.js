...
const getStats = async (req, res) => {
    try {
        ...
        // Optimization: Execute independent operations concurrently to prevent sequential bottlenecking
        const [
            statsMap,
            supplyDemand,
            totalProperties,
        ...
        console.log(`✅ statsMap, supplyDemand and counts calculated concurrently in ${Date.now() - start}ms`);
