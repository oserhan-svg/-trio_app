...
const getStats = async (req, res) => {
    try {
        ...
        // ⚡ Bolt: Execute independent Analytics and Prisma queries concurrently to significantly reduce API response time
        const [
            statsMap,
            supplyDemand,
            totalProperties,
        ...
        console.log(`✅ stats calculated in ${Date.now() - start}ms`);
