...
const getStats = async (req, res) => {
    try {
        ...
        // Performance Optimization: Parallelize independent data-fetching tasks
        // and consolidate multiple counts into a single raw SQL query to reduce DB round-trips.
