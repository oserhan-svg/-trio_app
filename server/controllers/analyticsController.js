...
const getStats = async (req, res) => {
    try {
        ...
        // ⚡ Bolt: Execute independent stats aggregations concurrently to prevent sequential waterfall latency
        const [
            statsMap,
            supplyDemand,
            totalProperties,
        ...
        console.log(`✅ Concurrent calculations completed in ${Date.now() - start}ms`);
