...
/**
 * Helper to perform authenticated fetch to the server using the API key from storage
 */
async function authenticatedFetch(url, options = {}) {
    ...
    if (!apiKey) {
        console.warn('⚠️ [SECURITY] EXTENSION_API_KEY missing in extension storage');
    }
