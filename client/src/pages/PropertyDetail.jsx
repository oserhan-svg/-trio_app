                            ...
                            <div className="flex flex-col gap-2">
                                <div className="relative w-full h-[400px] md:h-[500px] bg-gray-100 rounded-lg overflow-hidden group">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full opacity-0 focus-visible:opacity-100 group-hover:opacity-100 transition hover:bg-black/70 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full opacity-0 focus-visible:opacity-100 group-hover:opacity-100 transition hover:bg-black/70 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    >
                                        <ChevronLeft size={20} />
                                    </button>
                                </div>
