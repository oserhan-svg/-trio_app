                    ...
                    <div className="lg:col-span-12 animate-in slide-in-from-top duration-300">
                        <div className="bg-slate-50 border-2 border-slate-200 rounded-2xl p-6 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-4">
                                <button onClick={() => setShowAnalysis(false)} className="text-slate-400 hover:text-slate-600" aria-label="Analizi kapat"><X size={20} /></button>
                            </div>
                ...
                <div className="lg:col-span-3 space-y-4 h-fit lg:sticky lg:top-20">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                        <div className="p-3 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                            ...
                            <button onClick={() => { setTempNotes(client.notes || ''); setIsEditingInfo(true); }} className="text-gray-400 hover:text-blue-600" aria-label="Notu düzenle">
                                <Edit2 size={12} />
                            </button>
                        </div>
                                ...
                                {isEditingInfo ? (
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex justify-end gap-1">
                                            <button onClick={() => setIsEditingInfo(false)} className="p-1 hover:bg-gray-100 rounded" aria-label="İptal"><X size={14} /></button>
                                            <button onClick={handleSaveInfo} className="p-1 text-green-600 hover:bg-green-50 rounded" aria-label="Kaydet"><CheckCircle size={14} /></button>
                                        </div>
                                    </div>
                                ) : (
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                        <div className="p-3 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                            ...
                            <button onClick={() => { setSelectedDemand(null); setShowDemandModal(true); }} className="text-blue-600 hover:bg-blue-50 p-1 rounded" aria-label="Talep ekle">
                                <Plus size={14} />
                            </button>
                        </div>
                                                    ...
                                                    <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                                                        ...
                                                        <div className="flex items-end justify-between mt-2">
                                                                ...
                                                                {editingPropertyNote === prop.id ? (
                                                                    <div className="flex items-center gap-1">
                                                                        <input
                                                                            ...
                                                                            autoFocus
                                                                        />
                                                                        <button onClick={() => handleSavePropertyNote(p.id, prop.id)} className="text-green-600" aria-label="Notu kaydet"><CheckCircle size={14} /></button>
                                                                        <button onClick={() => setEditingPropertyNote(null)} className="text-gray-400" aria-label="İptal"><X size={14} /></button>
                                                                    </div>
                                                                ) : (
                                                                    <button
                                                            ...
                                                            <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                                <button onClick={() => window.open(`/property/${prop.id}`, '_blank')} className="p-1.5 text-gray-500 hover:bg-gray-200 rounded" title="Detay" aria-label="Detay"><FileText size={14} /></button>
                                                                <button onClick={() => handleRemoveProperty(prop.id)} className="p-1.5 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded" title="Kaldır" aria-label="Kaldır"><Trash2 size={14} /></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
