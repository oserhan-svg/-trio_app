            ...
            <div className="hidden lg:flex flex-col gap-6 bg-white dark:bg-slate-900 p-6 rounded-[2.5rem] shadow-xl shadow-blue-900/5 dark:shadow-blue-900/40 relative group z-[100] border border-transparent dark:border-slate-800 transition-colors duration-300">
                ...
                <div className="grid grid-cols-12 gap-6 pt-6 border-t border-slate-200/50 dark:border-slate-800">
                    ...
                    <div className="col-span-8 flex items-end justify-end gap-3">
                        <button
                            onClick={onClearAll}
                            className="h-12 w-12 flex items-center justify-center bg-rose-50 text-rose-500 rounded-2xl hover:bg-rose-500 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 transition-all active:scale-95 shadow-sm border border-rose-100/50"
                                        ...
                                        {savedSearches.length === 0 ? (
                                            ...
                                            savedSearches.map(s => (
                                                <div key={s.id} onClick={() => loadSavedSearch(s.filters)} className="group flex items-center justify-between p-3 rounded-2xl hover:bg-blue-600 dark:hover:bg-blue-500 cursor-pointer transition-all border border-transparent hover:shadow-lg hover:shadow-blue-500/20">
                                                    ...
                                                    <button onClick={(e) => { e.stopPropagation(); deleteSavedSearch(e, s.id); }} className="p-1.5 text-slate-400 dark:text-slate-500 group-hover:text-white/50 hover:text-white! focus-visible:outline-none group-focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-white transition-colors" aria-label="Kaydı Sil">
                                                        <X size={14} />
                                                    </button>
                                                </div>
                                            ))
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="p-1 px-1.5 hover:bg-rose-50 dark:hover:bg-rose-900/30 hover:text-rose-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 transition-all active:scale-75"
