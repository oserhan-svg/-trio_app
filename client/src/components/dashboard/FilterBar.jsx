                    ...
                    <div className="col-span-8 flex items-end justify-end gap-3">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`h-12 px-6 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 ${savedSearches.length > 0 ? 'text-slate-600 dark:text-slate-300 hover:bg-slate-900 dark:hover:bg-slate-100 dark:hover:text-slate-900 hover:text-white' : 'text-slate-300 dark:text-slate-600 opacity-50'}`}
                            >
                                <Sparkles size={14} />
                                        ...
                                        {savedSearches.length === 0 ? (
                                            ...
                                            savedSearches.map(s => (
                                                <div key={s.id} onClick={() => loadSavedSearch(s.filters)} className="group flex items-center justify-between p-3 rounded-2xl hover:bg-blue-600 dark:hover:bg-blue-500 cursor-pointer transition-all border border-transparent hover:shadow-lg hover:shadow-blue-500/20">
                                                    ...
                                                    <button onClick={(e) => { e.stopPropagation(); deleteSavedSearch(e, s.id); }} className="p-1.5 text-slate-400 dark:text-slate-500 group-hover:text-white/50 hover:text-white! transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white" aria-label="Kaydı Sil">
                                                        <X size={14} />
                                                    </button>
                                                </div>
                                            ))
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="p-1 px-1.5 hover:bg-rose-50 dark:hover:bg-rose-900/30 hover:text-rose-500 transition-all active:scale-75 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500"
                                    aria-label="Kapat"
                                >
