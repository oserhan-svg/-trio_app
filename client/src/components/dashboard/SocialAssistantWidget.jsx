                        ...
                        <div className="p-5">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <button
                                    ...
                                    className="text-gray-400 hover:text-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-1 transition-all"
                                    aria-label="Gönderi açıklamasını kopyala"
                                    title="Kopyala"
                                >
                                    <Copy size={16} />
                                </button>
                        ...
                        <div className="p-5">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <button
                                    ...
                                    className="text-gray-400 hover:text-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-1 transition-all"
                                    aria-label="Hikaye senaryosunu kopyala"
                                    title="Kopyala"
                                >
                                    <Copy size={16} />
                                </button>
