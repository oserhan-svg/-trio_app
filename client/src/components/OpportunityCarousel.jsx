                ...
                {opportunities.length > itemsPerSlide && (
                    <div className="flex gap-1">
                        <button
                            ...
                            className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 transition-colors shadow-sm"
                        >
