            ...
            <div className="flex items-center justify-between mb-2 px-1">
                ...
                {opportunities.length > itemsPerSlide && (
                    <div className="flex gap-1">
                        <button aria-label="Önceki fırsat" onClick={prevSlide} className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
                            <ChevronLeft size={12} className="text-gray-600" />
                        </button>
                        <button aria-label="Sonraki fırsat" onClick={nextSlide} className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
