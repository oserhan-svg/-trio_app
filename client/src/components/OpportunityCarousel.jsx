            ...
            <div className="flex items-center justify-between mb-2 px-1">
                ...
                {opportunities.length > itemsPerSlide && (
                    <div className="flex gap-1">
                        <button onClick={prevSlide} aria-label="Önceki fırsat" className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 transition-colors shadow-sm">
                            <ChevronLeft size={12} className="text-gray-600" />
                        </button>
                        <button onClick={nextSlide} aria-label="Sonraki fırsat" className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 transition-colors shadow-sm">
