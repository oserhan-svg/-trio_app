            ...
            <div className="flex items-center justify-between mb-2 px-1">
                ...
                {opportunities.length > itemsPerSlide && (
                    <div className="flex gap-1">
                        <button onClick={prevSlide} aria-label="Önceki fırsatlar" title="Önceki fırsatlar" className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
                            <ChevronLeft size={12} className="text-gray-600" />
                        </button>
                        <button onClick={nextSlide} aria-label="Sonraki fırsatlar" title="Sonraki fırsatlar" className="p-0.5 rounded border border-gray-100 bg-white hover:bg-gray-50 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
