...
const BottomNavItem = ({ icon: Icon, label, active, onClick }) => (
    <button
        ...
        className={`flex flex-col items-center justify-center gap-1 w-16 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded-xl ${active ? 'text-blue-600' : 'text-slate-400'}`}
    >
