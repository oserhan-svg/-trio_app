            ...
            <main className="flex-1 flex flex-col min-w-0 relative pb-20 md:pb-0">
                ...
                <header className="h-20 flex items-center justify-between px-4 md:px-8 relative shrink-0 z-40">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        <div className="hidden sm:flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-1.5 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 focus-within:ring-2 focus-within:ring-blue-500 transition-shadow">
