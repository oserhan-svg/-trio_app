                                ...
                                {group.items.map((item) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`
                                                w-full flex items-center gap-3.5 px-4 py-3 rounded-2xl transition-all duration-300 group relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900
                                                ${active
            ...
            <main className="flex-1 flex flex-col min-w-0 relative pb-20 md:pb-0">
                ...
                <header className="h-20 flex items-center justify-between px-4 md:px-8 relative shrink-0 z-40">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <button
                            className="bg-slate-900 dark:bg-blue-600 text-white h-10 px-4 rounded-xl flex items-center gap-2 shadow-lg hover:shadow-blue-500/20 hover:-translate-y-0.5 transition-all text-xs font-black uppercase tracking-widest active:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 dark:focus-visible:ring-offset-slate-900"
...
const BottomNavItem = ({ icon: Icon, label, active, onClick }) => (
    <button
        onClick={onClick}
        aria-current={active ? 'page' : undefined}
        className={`flex flex-col items-center justify-center gap-1 w-16 transition-all duration-300 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${active ? 'text-blue-600' : 'text-slate-400'}`}
    >
