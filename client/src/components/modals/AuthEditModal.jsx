            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <div className="flex justify-end gap-2 pt-4 border-t border-gray-100 mt-2">
                        <Button type="button" variant="ghost" onClick={onClose} className="!px-4 !py-2 !text-sm !rounded-lg">İptal</Button>
                        <Button
                            type="submit"
                            isLoading={saving}
                            disabled={uploading}
                            className="!px-4 !py-2 !text-sm !rounded-lg bg-blue-600 hover:bg-blue-700 shadow-blue-200"
                        >
                            Kaydet
                        </Button>
                    </div>
